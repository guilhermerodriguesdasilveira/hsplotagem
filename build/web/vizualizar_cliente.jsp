<%-- 
    Document   : vizualizar_cliente
    Created on : 11/04/2018, 11:04:59
    Author     : Guilherme
--%>
    ...
    <body class="margem">
        ...
        <%
         String idcliente = request.getParameter("idcliente");
                    ...
                    String sql = "SELECT * FROM cliente,estados,perfil where cliente.id_perfil = perfil.id_perfil and cliente.id_estado = estados.id_estado and id_cliente = "+idcliente;
        ...
        <div>
             ...
             <center><h2> Vizualizar Cliente </h2></center>
        </div>
