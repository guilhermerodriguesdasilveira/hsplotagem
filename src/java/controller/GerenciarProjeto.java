...
public class GerenciarProjeto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            try{
                ...
                if(request.getParameter("acao").equals("alterar")){  
                        ...
                        if(novo.getIdprojeto()>0){
                            RequestDispatcher disp = getServletContext().getRequestDispatcher("/form_projeto.jsp");
                ...
                if(request.getParameter("acao").equals("visualizar")){
                    ...
                    novo = p.getCarregaPorId(idprojeto);
                    if(novo.getIdprojeto()>0){
                        RequestDispatcher disp = getServletContext().getRequestDispatcher("/visualizar_projeto.jsp");
            ...
            out.println("location.href='listar_projeto.jsp';");
            out.println("</script>");
