<%-- 
    Document   : form_cliente_logado
    Created on : 15/06/2018, 21:51:19
    Author     : Guilherme
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="gerenciar_cliente2.do" method="post">
                ...
                <div class="row">
                    ...
                    <a href="minha_conta.jsp" class="btn btn-warning">Voltar</a>
                </div>
            </form>
