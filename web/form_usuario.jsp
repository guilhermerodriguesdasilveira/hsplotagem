<%-- 
    Document   : index
    Created on : 05/03/2018, 08:30:24
    ...
    <body>
        <div>
             ...
             <%@include file="menu_restrito.jsp" %>
                ...
                <center><h3> Cadastro de Usuario </h3></center>
            ...
            <form action="gerenciar_usuario.do" method="post">
                ...
                <div class="row">
                    <div class="form-group col-sm-8">
                        ...
                        <input type="email" class="form-control" id="email" 
                               name="email" required maxlength="22" value="${usuario.email}"/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-8">
                        ...
                        <select id="idperfil" name="idperfil" class="form-control" required>
